...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Great', 0.85], //From 80% to 89%
		['Sick!', 0.9], //From 90% to 99%
		['Perfect!!', 0.95], //The value on this one isn't used actually, since Perfect is always "1"
		['MASTER!!!', 1]
	];
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Background Change':
				var bg1:BGSprite = new BGSprite(value1, 0, 0, 0.9, 0.9);
				add(bg1);
				var bg2:BGSprite = new BGSprite(value2, 0, 0, 0.9, 0.9);
				remove(bg2);
			case 'Dadbattle Spotlight':
